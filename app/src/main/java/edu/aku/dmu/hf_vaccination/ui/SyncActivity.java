...
import static edu.aku.dmu.hf_vaccination.core.MainApp.sdDir;
import static edu.aku.dmu.hf_vaccination.core.MainApp.uploadData;
...
import edu.aku.dmu.hf_vaccination.adapters.SyncListAdapter;
...
import edu.aku.dmu.hf_vaccination.contracts.TableContracts.VersionTable;
import edu.aku.dmu.hf_vaccination.core.MainApp;
import edu.aku.dmu.hf_vaccination.database.DatabaseHelper;
import edu.aku.dmu.hf_vaccination.databinding.ActivitySyncBinding;
import edu.aku.dmu.hf_vaccination.models.SyncModel;
import edu.aku.dmu.hf_vaccination.workers.DataDownWorkerALL;
import edu.aku.dmu.hf_vaccination.workers.DataUpWorkerALL;
import edu.aku.dmu.hf_vaccination.workers.PhotoUploadWorker2;
