...
public class EntryLog extends BaseObservable implements Observable {
    ...
    public void populateMeta() {
        ...
        setUuid(MainApp.formVB.getUid());  // not applicable in Form table
...
//        setPsuCode(MainApp.form.getPsuCode());
        setiStatus(MainApp.formVB.getiStatus());
        setiStatus96x(MainApp.formVB.getiStatus96x());
        setAppver(MainApp.appInfo.getAppVersion());
        setEntryType(MainApp.formVB.getEntryType());
